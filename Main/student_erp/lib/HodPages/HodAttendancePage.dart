              ...
              child: DashboardCard(
                ...
                widgets: [
                  ...
                  StatWidget(
                    label: 'On Duty',
                    count: todayAttendance
                        .where((student) => student['isOnDuty'])
                        .length,
                    countColor: Colors.orange,
                    onStatClicked: () {},
                  ),
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  title: Text(
                    ...
                    style:
                        TextStyle(color: studentColor), // Color based on status
                  ),
                  subtitle: Text(
                      'Mentor: ${student['mentor']}, Phone: ${student['phone']}'),
                  trailing: IconButton(
                          ...
                          return AlertDialog(
                            ...
                            content: Column(
                              ...
                              children: [
                                ...
                                Text(
                                    'Status: ${student['isAbsent'] ? "Absent" : student['isOnDuty'] ? "On Duty" : "Present"}'),
                              ],
                            ),
                            actions: [
                              TextButton(
                  ...
                  leading: Icon(
                    student['isPresent']
                        ...
                        : Icons.remove_circle,
                    color:
                        studentColor, // Green for present, Red for absent, Orange for on duty
                  ),
                );
              },
            ),
