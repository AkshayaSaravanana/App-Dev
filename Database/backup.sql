...
--
-- Host: localhost    Database: student_erp
-- ------------------------------------------------------
...
CREATE TABLE `students` (
  ...
  `hostel_fee` float DEFAULT NULL,
  `bus_fee` float DEFAULT NULL,
  `college_fee` double DEFAULT NULL,
...
-- Dump completed on 2024-09-15 14:12:27
